...
type SSLKeyAndCertificate struct {
	...
	// States if the certificate is base64 encoded. Field introduced in 18.1.2.
	...
	// States if the private key is base64 encoded. Field introduced in 18.1.2.
	...
	// Passphrase used to encrypt the private key. Field introduced in 18.1.2.
