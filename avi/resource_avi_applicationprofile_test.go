		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"avi_applicationprofile.testApplicationProfile", "name", "testSystem-Secure-HTTP")),
			},
			{
...
resource "avi_applicationprofile" "testApplicationProfile" {
	...
	"http_profile" {
		...
		"client_max_header_size" = "48"
		"client_max_request_size" = "36"
		"cache_config" {
			"min_object_size" = "100"
		...
		"post_accept_timeout" = "300000"
		"secure_cookie_enabled" = true
		"max_response_headers_size" = "36"
