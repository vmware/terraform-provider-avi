...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"avi_passwordpolicy":                  dataSourceAviPasswordPolicy(),
			...
			"avi_applicationinsightsstate":        dataSourceAviApplicationInsightsState(),
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"avi_passwordpolicy":                  resourceAviPasswordPolicy(),
			...
			"avi_applicationinsightsstate":        resourceAviApplicationInsightsState(),
