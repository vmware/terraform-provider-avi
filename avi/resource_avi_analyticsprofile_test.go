		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "apdex_server_rtt_tolerated_factor", "4.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_nonpfs_penalty", "1.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_tls12_score", "5.0"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_pscore_traffic_threshold_l4_client", "10.0"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_cipherscore_ge128b", "5.0"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_tls11_score", "5.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "exclude_gs_down_as_error", "false"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "apdex_server_response_tolerated_factor", "4.0"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_weak_signature_algo_penalty", "1.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "exclude_persistence_change_as_error", "false"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_selfsignedcert_penalty", "1.0"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "apdex_rtt_tolerated_factor", "4.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_certscore_gt30d", "5.0"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "apdex_rum_tolerated_factor", "4.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_cipherscore_eq000b", "0.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_certscore_le30d", "4.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_pscore_traffic_threshold_l4_server", "10.0"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_hsts_penalty", "1.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "exclude_server_dns_error_as_error", "false"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_certscore_le07d", "2.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "apdex_response_tolerated_factor", "4.0"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_encalgo_score_none", "0.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "exclude_dns_policy_drop_as_significant", "false"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_chain_invalidity_penalty", "1.0"),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_tls10_score", "5.0"),
					resource.TestCheckResourceAttr(
						"avi_analyticsprofile.testAnalyticsProfile", "hs_security_certscore_expired", "0.0"),
					resource.TestCheckResourceAttr(
