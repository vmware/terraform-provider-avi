...
* `cc_props` - (Optional) Cloudconnector properties. Allowed in enterprise with any value edition, essentials edition, basic edition, enterprise with cloud services edition.
...
* `hyp_props` - (Optional) Hypervisor properties. Allowed in enterprise with any value edition, essentials edition, basic edition, enterprise with cloud services edition.
* `info` - (Optional) Properties specific to a cloud type. Allowed in enterprise with any value edition, essentials edition, basic edition, enterprise with cloud services edition.
