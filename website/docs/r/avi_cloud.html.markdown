...
* `disable_metrics_polling` - (Optional) To disable metrics collection. Field introduced in 32.1.1. Allowed with any value in enterprise, enterprise with cloud services edition. 
