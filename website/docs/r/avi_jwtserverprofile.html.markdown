...
* `protected_resource_config` - (Optional) Oauth 2.0 protected resource metadata configuration (rfc 9728). Only applicable when jwt_profile_type is client_auth. Field introduced in 32.1.1. Allowed with any value in enterprise, enterprise with cloud services edition. 
