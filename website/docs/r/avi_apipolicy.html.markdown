...
* `file_object_refs` - (Optional) Uuid of the uploaded openapi specification file associated with this policy. Only one file is supported at a time. It is a reference to an object of type fileobject. Field introduced in 32.2.1. Maximum of 1 items allowed. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
