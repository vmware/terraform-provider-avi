...
* `error_pages` - (Optional) Defined error pages for http status codes. Field introduced in 17.2.4. Allowed in enterprise with any value edition, essentials edition, basic edition, enterprise with cloud services edition.
