...
* `api_spec_detail` - (Optional) Api specification details extracted from the file, populated for open_api_spec type only. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `completed_events` - (Optional) Number of processing events that have completed. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `duration` - (Optional) Time taken to complete the operation in seconds. Field introduced in 32.2.1. Unit is sec. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
* `end_time` - (Optional) End time of the file object processing operation. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `history` - (Optional) File object processing events history for the version specified. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `progress` - (Optional) Percentage of completed events. Allowed values are 0-100. Field introduced in 32.2.1. Unit is percent. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `start_time` - (Optional) Start time of the file object processing operation. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
* `state` - (Optional) State of the file object. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
* `task_events` - (Optional) File object processing events for the version specified. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `total_events` - (Optional) Total number of processing events for this file object. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
