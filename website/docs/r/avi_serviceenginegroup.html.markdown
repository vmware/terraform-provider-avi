...
* `markers` - (Optional) List of labels to be used for granular rbac. Field introduced in 21.1.1. Allowed in basic edition, essentials edition, enterprise edition.
