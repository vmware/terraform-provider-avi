...
* `skip_auto_chain` - (Optional) Skip automatic chain selection for the certificate. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
