...
* `imap_monitor` - (Optional) Health monitor for imap. Field introduced in 20.1.5.
* `imaps_monitor` - (Optional) Health monitor for imaps. Field introduced in 20.1.5.
...
* `pop3_monitor` - (Optional) Health monitor for pop3. Field introduced in 20.1.5.
* `pop3s_monitor` - (Optional) Health monitor for pop3s. Field introduced in 20.1.5.
...
* `smtp_monitor` - (Optional) Health monitor for smtp. Field introduced in 20.1.5.
* `smtps_monitor` - (Optional) Health monitor for smtps. Field introduced in 20.1.5.
