...
* `intelligent_assist_enabled` - (Optional) Enable or disable intelligent assist feature on the controller. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
