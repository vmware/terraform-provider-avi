...
* `ai_assistant_enabled` - (Optional) Enable or disable ai assistant feature on the controller. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `certificate_security_policy` - (Optional) Certificate security policy for the system. Field introduced in 32.1.3, 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `gslb_client_cert_ref` - (Optional) Client certificate for mutual tls authentication. Required when tls_mode is tls_mode_mtls. It is a reference to an object of type sslkeyandcertificate. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `syslog_server_settings` - (Optional) Syslog server destinations including address, port, transport protocol, and output format. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `truststore_ca_certs_pem` - (Optional) Resolved ca certificate chain pem for the system truststore pki profile. Populated by the controller before pushing to ses; not user-configurable. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
