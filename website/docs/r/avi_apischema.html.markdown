...
* `additional_properties_schema` - (Optional) Schema for the additional properties. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
* `allow_additional_properties` - (Optional) Whether this schema allows additional properties. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `composite_types` - (Optional) List of types that are part of the oneof, any_of or all_of. Field introduced in 32.2.1. Maximum of 32 items allowed. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `discriminator` - (Optional) Discriminator for the composite types. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `object_properties` - (Optional) List of properties for this object schema. Field introduced in 32.2.1. Maximum of 256 items allowed. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
* `source` - (Optional) Source of the api schema. Enum options - SOURCE_USER_DEFINED, SOURCE_API_SPEC, SOURCE_DISCOVERED. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
