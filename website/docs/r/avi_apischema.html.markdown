...
* `composite_types` - (Optional) List of types that are part of the oneof, any_of or all_of. Field introduced in 32.2.1. Maximum of 64 items allowed. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
