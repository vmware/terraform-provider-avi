...
* `api_policy_ref` - (Optional) Api policy configuration for the virtual service to apply api protection. It is a reference to an object of type apipolicy. Field introduced in 32.1.4. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `label_profile_ref` - (Optional) Label profile configuration for the virtual service to categorize api endpoints. It is a reference to an object of type labelprofile. Field introduced in 32.1.4. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
...
* `session_key_forwarder_ref` - (Optional) Session key forwarder profile for the virtual service for the session key forwarding. It is a reference to an object of type sessionkeyforwarder. Field introduced in 32.1.4. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition. 
