...
* `nsx_groups` - An nsx group that maps to a dynamic collection of ip addresses, derived from its definition in nsx. Field introduced in 32.1.1. Maximum of 1 items allowed. Allowed with any value in enterprise, enterprise with cloud services edition.
