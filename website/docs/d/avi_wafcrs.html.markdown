...
* `allowed_request_content_type_charsets` - Allowed request content type character sets in waf. Field introduced in 30.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition.
...
* `files` - List of data files used for waf rules. Field introduced in 30.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition.
...
* `integrity_values` - Integrity protection values for crs. Field introduced in 30.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition.
...
* `restricted_extensions` - Waf restricted file extensions. Field introduced in 30.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition.
* `restricted_headers` - Waf restricted http headers. Field introduced in 30.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition.
