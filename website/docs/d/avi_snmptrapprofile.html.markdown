...
* `name` - A user-friendly name of the snmp trap configuration. Allowed in enterprise with any value edition, essentials edition, basic edition, enterprise with cloud services edition.
...
* `trap_servers` - The ip address or hostname of the snmp trap destination server. Allowed in enterprise with any value edition, essentials edition, basic edition, enterprise with cloud services edition.
