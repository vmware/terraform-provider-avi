...
* `intelligent_assist_project_key` - Project key for the intelligent assist feature. Field introduced in 32.2.1. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition.
