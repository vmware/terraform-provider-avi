...
* `certificate_security_policy` - Certificate security policy for the system. Field introduced in 32.2.1, 32.1.3. Allowed with any value in enterprise, essentials, basic, enterprise with cloud services edition.
