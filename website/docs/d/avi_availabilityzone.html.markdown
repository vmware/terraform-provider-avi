...
* `vsphere_zones` - Vsphere zone associated with the az. Field introduced in 31.3.1. Maximum of 1 items allowed. Allowed with any value in enterprise, enterprise with cloud services edition.
